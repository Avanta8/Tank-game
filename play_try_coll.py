...
class SpSurv:
    ...
    def ai_move(self):
        for i, tank in enumerate(self.ai_tanks):
            ...
            if collided:
                tank.next_move_lens = [0, 0]
                for c in collided:
                    tank.next_move_lens[0] += c.next_move_lens[0] - 1
                    tank.next_move_lens[1] += c.next_move_lens[1] - 1
                continue
